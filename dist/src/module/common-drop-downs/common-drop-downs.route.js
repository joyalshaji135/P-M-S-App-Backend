...
const commonDropDownController = __importStar(require("./common-drop-downs.controllers"));
...
router.get('/team-manager-list', commonDropDownController.getAllTeamManagerList);
...
router.get('/customer-type-list', commonDropDownController.getAllCustomerTypeList);
...
router.get('/industry-nature-list', commonDropDownController.getAllIndustryNatures);
