...
exports.changeRoleBaseStatus = exports.deleteRoleBase = exports.getAllRoleBases = exports.updateById = exports.findById = exports.isNameAliasExists = exports.isNameExists = exports.create = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const role_model_1 = __importDefault(require("@models/lookups-models/role.model"));
const create = (roleBaseData) => __awaiter(void 0, void 0, void 0, function* () {
    const roleBase = new role_model_1.default(roleBaseData);
    return yield roleBase.save();
});
...
const isNameExists = (name, idToExclude) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield role_model_1.default.findOne(filter).exec();
});
...
const deleteRoleBase = (roleBaseId, deletedBy) => __awaiter(void 0, void 0, void 0, function* () {
    return role_model_1.default.findByIdAndUpdate(roleBaseId, {
        $set: {
            isDeleted: true,
            deletedBy,
            deletedAt: new Date(),
...
const changeRoleBaseStatus = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    return role_model_1.default.findByIdAndUpdate(id, {
        $set: {
...
exports.changeRoleBaseStatus = changeRoleBaseStatus;
