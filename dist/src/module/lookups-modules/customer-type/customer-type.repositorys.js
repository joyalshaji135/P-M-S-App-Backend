...
exports.changeCustomerTypeStatus = exports.deleteCustomerType = exports.getAllCustomerTypes = exports.updateById = exports.findById = exports.isNameAliasExists = exports.isNameExists = exports.create = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const customer_type_model_1 = __importDefault(require("@models/lookups-models/customer-type.model"));
const create = (customerTypeData) => __awaiter(void 0, void 0, void 0, function* () {
    const customerType = new customer_type_model_1.default(customerTypeData);
    return yield customerType.save();
});
...
const isNameExists = (name, idToExclude) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield customer_type_model_1.default.findOne(filter).exec();
});
...
const deleteCustomerType = (customerTypeId, deletedBy) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_type_model_1.default.findByIdAndUpdate(customerTypeId, {
        $set: {
            isDeleted: true,
            deletedBy,
            deletedAt: new Date(),
...
const changeCustomerTypeStatus = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_type_model_1.default.findByIdAndUpdate(id, {
        $set: {
...
exports.changeCustomerTypeStatus = changeCustomerTypeStatus;
