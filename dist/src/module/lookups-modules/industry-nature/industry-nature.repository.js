...
exports.changeIndustrynatureStatus = exports.deleteIndustrynature = exports.getAllIndustrynatures = exports.updateById = exports.findById = exports.isNameAliasExists = exports.isNameExists = exports.create = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const industry_model_1 = __importDefault(require("@models/lookups-models/industry.model"));
const create = (industrynatureData) => __awaiter(void 0, void 0, void 0, function* () {
    const industrynature = new industry_model_1.default(industrynatureData);
    return yield industrynature.save();
});
...
const isNameExists = (name, idToExclude) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield industry_model_1.default.findOne(filter).exec();
});
...
const deleteIndustrynature = (industrynatureId, deletedBy) => __awaiter(void 0, void 0, void 0, function* () {
    return industry_model_1.default.findByIdAndUpdate(industrynatureId, {
        $set: {
            isDeleted: true,
            deletedBy,
            deletedAt: new Date(),
...
const changeIndustrynatureStatus = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    return industry_model_1.default.findByIdAndUpdate(id, {
        $set: {
...
exports.changeIndustrynatureStatus = changeIndustrynatureStatus;
