...
exports.changeTaskModuleStatus = exports.deleteTaskModule = exports.getAllTaskModules = exports.updateById = exports.findById = exports.isNameAliasExists = exports.isNameExists = exports.create = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const task_module_model_1 = __importDefault(require("@models/lookups-models/task-module.model"));
const create = (taskModuleData) => __awaiter(void 0, void 0, void 0, function* () {
    const taskModule = new task_module_model_1.default(taskModuleData);
    return yield taskModule.save();
});
...
const isNameExists = (name, idToExclude) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield task_module_model_1.default.findOne(filter).exec();
});
...
const deleteTaskModule = (taskModuleId, deletedBy) => __awaiter(void 0, void 0, void 0, function* () {
    return task_module_model_1.default.findByIdAndUpdate(taskModuleId, {
        $set: {
            isDeleted: true,
            deletedBy,
            deletedAt: new Date(),
...
const changeTaskModuleStatus = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    return task_module_model_1.default.findByIdAndUpdate(id, {
        $set: {
...
exports.changeTaskModuleStatus = changeTaskModuleStatus;
