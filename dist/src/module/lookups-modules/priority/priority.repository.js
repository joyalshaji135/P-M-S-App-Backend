...
exports.changePriorityStatus = exports.deletePriority = exports.getAllPriorities = exports.updateById = exports.findById = exports.isNameAliasExists = exports.isNameExists = exports.create = void 0;
...
const priority_model_1 = __importDefault(require("@models/lookups-models/priority.model"));
const create = (priorityData) => __awaiter(void 0, void 0, void 0, function* () {
    const priority = new priority_model_1.default(priorityData);
    return yield priority.save();
});
...
const isNameExists = (name, idToExclude) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield priority_model_1.default.findOne(filter).exec();
});
...
const deletePriority = (priorityId, deletedBy) => __awaiter(void 0, void 0, void 0, function* () {
    return priority_model_1.default.findByIdAndUpdate(priorityId, {
        $set: {
            isDeleted: true,
            deletedBy,
            deletedAt: new Date(),
...
const changePriorityStatus = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    return priority_model_1.default.findByIdAndUpdate(id, {
        $set: {
...
function createTaskModuleProfile(taskModuleData) {
    throw new Error('Function not implemented.');
}
function getPriorityById(id) {
    throw new Error('Function not implemented.');
}
function editPriorityProfile(id, priorityData) {
    throw new Error('Function not implemented.');
}
