...
const superAdminControllers = __importStar(require("./super-admins.controllers"));
...
router.get('/get-all-super-admin', superAdminControllers.getAllSuperAdminsController);
