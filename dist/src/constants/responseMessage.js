...
exports.message = {
    ...
    LOOKUP_CODE_ALREADY_EXISTS: 'A LookupCode with the same type, name, or code already exists.',
    ...
    INDUSTRY_PROJECT_STATUS_UPDATED: 'Industry project status updated successfully',
    ...
    RECRUITMENT_POST_STATUS_UPDATED: 'Recruitment post status updated successfully',
