...
const alertModeSchema = new mongoose_1.Schema({
...
alertModeSchema.add(base_model_1.baseSchema);
exports.default = mongoose_1.default.model('alertMode', alertModeSchema);
