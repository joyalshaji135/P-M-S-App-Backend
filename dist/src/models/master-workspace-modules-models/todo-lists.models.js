...
const todoListsSchema = new mongoose_1.Schema({
...
todoListsSchema.add(base_model_1.baseSchema);
exports.default = mongoose_1.default.model('todoLists', todoListsSchema);
