...
const eventProgramsSchema = new mongoose_1.Schema({
...
eventProgramsSchema.add(base_model_1.baseSchema);
exports.default = mongoose_1.default.model('eventPrograms', eventProgramsSchema);
