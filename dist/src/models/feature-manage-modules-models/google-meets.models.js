...
const googleMeetSchema = new mongoose_1.Schema({
...
googleMeetSchema.add(base_model_1.baseSchema);
exports.default = mongoose_1.default.model('googleMeet', googleMeetSchema);
