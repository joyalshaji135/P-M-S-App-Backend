...
const recruitmentPostSchema = new mongoose_1.Schema({
...
recruitmentPostSchema.add(base_model_1.baseSchema);
exports.default = mongoose_1.default.model('recruitmentPost', recruitmentPostSchema);
