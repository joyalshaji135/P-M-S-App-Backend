export const message = {
  ...
  GET_INDUSTRY_PROJECT_COUNT_SUCCESS: "industry project count fetched successfully",
  ...
  GET_CLIENT_FEEDBACK_COUNT_SUCCESS: "client feedback count fetched successfully",
  ...
  GET_RECRUITMENT_POST_COUNT_SUCCESS: "recruitment post count fetched successfully",
  GET_DOMAIN_COUNT_SUCCESS: "domain count fetched successfully",
  GET_INDUSTRY_NATURE_COUNT_SUCCESS: "industry nature count fetched successfully",
