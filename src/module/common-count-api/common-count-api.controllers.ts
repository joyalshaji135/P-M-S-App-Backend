...
export const getAllCompanyOwnerCount = async (
    ...
    try {
      ...
      const companyOwnerCount = await commonCountApiServices.getAllCompanyOwnerCount();
...
export const getAllTeamManagerCount = async (
    ...
    try {
      ...
      const teamManagerCount = await commonCountApiServices.getAllTeamManagerCount();
      return res.status(200).json({
        success: true,
...
export const getAllTeamMemberCount = async (
    ...
    try {
      ...
      const teamMemberCount = await commonCountApiServices.getAllTeamMemberCount();
      return res.status(200).json({
        success: true,
...
export const getAllGoogleMeetCount = async (
    ...
    try {
      ...
      const googleMeetCount = await commonCountApiServices.getAllGoogleMeetCount();
      return res.status(200).json({
        success: true,
...
export const getAllRecruitmentCount = async (
    ...
    try {
      ...
      const recruitmentCount = await commonCountApiServices.getAllRecruitmentCount();
      return res.status(200).json({
        success: true,
...
export const getAllDocumentFileCount = async (
    ...
    try {
      ...
      const documentFileCount = await commonCountApiServices.getAllDocumentFileCount();
      return res.status(200).json({
        success: true,
