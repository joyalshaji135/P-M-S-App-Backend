...
} from '@src/models/lookups-models/customer-type.model';
import domainModel, {
  domainDocument,
} from '@src/models/lookups-models/domain.model';
import industryModel, {
  industryDocument,
} from '@src/models/lookups-models/industry.model';
import roleModel, {
  roleBaseDocument,
} from '@src/models/lookups-models/role.model';
import taskModuleModel, {
  taskModuleDocument,
} from '@src/models/lookups-models/task-module.model';
import priorityModel, {
  priorityDocument,
} from '@src/models/lookups-models/priority.model';
import industryProjectsModels, {
  industryProjectDocument,
} from '@src/models/master-workspace-modules-models/industry-projects.models';
...
export const getAllDomainListRepository = async (): Promise<
  domainDocument[]
> => {
  return domainModel
...
export const getAllIndustryNaturesRepository = async (): Promise<
  industryDocument[]
> => {
...
export const getAllTaskModulesRepository = async (): Promise<
  taskModuleDocument[]
> => {
...
export const getAllPriorityRepository = async (): Promise<
  priorityDocument[]
> => {
